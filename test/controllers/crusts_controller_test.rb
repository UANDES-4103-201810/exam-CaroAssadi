...
class CrustsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crust" do
    assert_difference('Crust.count') do
      post crusts_url, params: { crust: { pizza_id: @crust.pizza_id, price: @crust.price, type: @crust.type } }
    end
  ...
  test "should update crust" do
    patch crust_url(@crust), params: { crust: { pizza_id: @crust.pizza_id, price: @crust.price, type: @crust.type } }
